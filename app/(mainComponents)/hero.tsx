  ...
  return (
    <div className="w-full h-[100svh] bg-background flex flex-col items-center md:items-start justify-start">
      ...
      <div className="h-[20%] md:w-[40vw] w-full flex flex-col items-center justify-start md:justify-center ">
        <p className="px-10 p-3 pl-6 pr-6 font-black border border-b-4 border-l-4 border-black rounded-lg shadow-lg text-[30px] text-background bg-headingBlue hover:cursor-pointer  hover:text-headingBlue hover:bg-background transition-all ease-in-out duration-300">
          Get Started
        </p>
      </div>
    </div>
